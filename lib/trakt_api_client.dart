...
export 'src/models/trakt_media_metadata.dart';
...
export 'src/models/trakt_sharing_text.dart';
...
export 'src/models/trakt_trailers.dart';
export 'src/models/trakt_user.dart';
export 'src/models/trakt_user_account.dart';
export 'src/models/trakt_user_connections.dart';
export 'src/models/trakt_user_images.dart';
