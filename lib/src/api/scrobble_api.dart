...
class ScrobbleApi {
  ...
  Future<TraktScrobbleResponse> startMovie(
    TraktMovie movie, {
    double progress = 0,
    String? appVersion,
    String? appDate,
  ...
  Future<TraktScrobbleResponse> pauseMovie(
    TraktMovie movie, {
    double progress = 0,
    String? appVersion,
    String? appDate,
  ...
  Future<TraktScrobbleResponse> stopMovie(
    TraktMovie movie, {
    double progress = 100,
    String? appVersion,
    String? appDate,
  ...
  Future<TraktScrobbleResponse> startEpisode(
  ...
  Future<TraktScrobbleResponse> pauseEpisode(
    TraktEpisode episode, {
    double progress = 0,
    String? appVersion,
    String? appDate,
  ...
  Future<TraktScrobbleResponse> stopEpisode(
    TraktEpisode episode, {
    double progress = 100,
    String? appVersion,
    String? appDate,
